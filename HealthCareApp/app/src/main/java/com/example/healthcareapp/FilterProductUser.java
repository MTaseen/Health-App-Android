...
public class FilterProductUser extends Filter {
    ...
    private AdapterIllnessDataUser adapter;
    private ArrayList<ModelIllnessData> filterList;

    public FilterProductUser(AdapterIllnessDataUser adapter, ArrayList<ModelIllnessData> filterList) {
    ...
    protected void publishResults(CharSequence constraint, FilterResults results) {
        adapter.illnessDataList = (ArrayList<ModelIllnessData>) results.values;
